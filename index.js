...
artists[8].name = artists[8].name = 'Vincent Van Gogh';
...
console.log(addArtist(artists,'Deanda Noble', '1969-2022', 'Full Stack Development', 'African American', 'I am a servant of the most high God.'));
